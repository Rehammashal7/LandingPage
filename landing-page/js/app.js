...
function generateNav() {
    ...
    for (let section of sections) {
        ...
        ul.insertAdjacentHTML("beforeend", `<li><a class="menu__link" id = Link${section.id}  href="#${section.id}">${section.dataset.nav}</a></li>`);
    }
...
function activeSection() {
    ...
    for (let section of sections) {
        ...
        if (boundCheck.top <= 250 && boundCheck.top >= 0) {
